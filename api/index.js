...
app.post('/api/analyze', async (req, res) => {
  try {
    ...
    console.log(`[Vercel API] Analyzing request. Text length: ${text?.length || 0}, Has Image: ${Boolean(imageBase64)}, Live Location: ${liveLocation || 'None'}`);
    ...
    console.error('[Vercel API] Analysis failed:', error);
